...
const static char* PWD = "pwd";
const static char* SESSIONID = "sessionid";
const static char* DOMAIN_NAME = "t04.com";
...
const static char* CREDENTIALS = "/credentials";
const static char* CHANGEPWD = "/changepwd";
const static char* CHECKPWD = "/checkpwd";
...
const static char* DELETE_EMAIL = "/deleteEmail";
const static char* MOVE_FILE = "/moveFile";
const static char* RENAME_FILE = "/renameFile";
const static char* DELETE_FILE = "/deleteFile";
